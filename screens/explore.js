                        ...
                        <ScrollView showsHorizontalScrollIndicator={false}  horizontal={true}>
                            {
                                categories.map(category=>(
                                    <Text key={category.id}style={styles.category}> {category.categoryName} </Text>
                                ))
                            }
                    ...
                    <View style={styles.exploreMediaContainer}>
                        <ScrollView showsVerticalScrollIndicator={false}>
                            <View style={{flexDirection:"row"}}>
                                ...
                                <View style={styles.mediaImageContainer}>
                                    <Image resizeMode="cover"  style={styles.image} source={{uri:"https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcScbCH9nEkq0wlDTl6y1Yfksd_HHHdeO8zC48IS24uz4l6lfi0n"}}></Image>
                                </View>
                            </View>  
                            <View>
                                <View style={[styles.mediaImageContainer,{width:350,height:230}]}>
                                    <Image resizeMode="cover" style={styles.image} source={{uri:"https://cdn.cnn.com/cnnnext/dam/assets/161201144840-5-mumbai-street-food-chutney-sandwich.jpg"}}></Image>
                                </View>
                            </View> 
                            <View style={{flexDirection:"row"}}> 
                                <View style={[styles.mediaImageContainer,{width:175,height:300}]}>
                                    <Image resizeMode="cover" style={styles.image} source={{uri:"https://media-cdn.tripadvisor.com/media/photo-s/19/14/bf/33/photo0jpg.jpg"}}></Image>
                                </View>
                                <View style={{flexDirection:"column"}}>
                                    <View style={[styles.mediaImageContainer,{width:175,height:150}]}>
                                        <Image resizeMode="cover" style={styles.image} source={{uri:"https://www.holidify.com/blog/wp-content/uploads/2015/09/patti-samosa.jpg"}}></Image>
                                    </View>
                                    <View style={[styles.mediaImageContainer,{width:175,height:150}]}>
                                        <Image resizeMode="cover" style={styles.image} source={{uri:"https://s3-eu-west-1.amazonaws.com/iya-news-prod.inyourarea.co.uk/2018/11/Greek-street-food-comes-to-Canary-Wharf-with-the-launch-of-The-Athenian-_-The-Wharf3.jpg"}}></Image>
                                    </View>
                                </View>
                            </View> 
                        </ScrollView>    
