...
import { View, Text, StyleSheet, ImageBackground ,StatusBar,ScrollView,Image} from "react-native";
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{marginTop:defaultHeight+50}}>
        <ProfileImageComponent imageUrl={"https://lh3.googleusercontent.com/proxy/ErDRclXNJAML1EoOqTyjsgnvbJTJNrGs64y5TkEWJYFJhU1kOq8G8Y1EktNot_Fx5twoYJzcDXlAs-tJQ6Xe2wM_nACJuHTWs4oJA8F8V_II5rt3EYumnoYsS38"}/>
      </View>

      <View style={styles.infoContainer}>
          <Text style={[styles.text,{fontWeight:"200" , fontSize:30}]}>User Name</Text>
          <Text style={[styles.text,{fontWeight:"200" , fontSize:15}]}>email@gmail.com</Text>
      </View>
      ...
      <View style={{marginTop:20}}>
          <Text style={[styles.subText,{marginLeft:15,fontSize:17,color:"#52575D",marginBottom:10,borderBottomColor:"black",borderBottomWidth:0.2}]}>Liked videos</Text>
        ...
        <View style={{marginTop:20}}>
          <Text style={[styles.subText,{marginLeft:15,fontSize:17,color:"#52575D",marginBottom:10,borderBottomColor:"black",borderBottomWidth:0.2}]}>Favourite videos</Text>
          <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
              <View style={styles.mediaImageContainer}>
                   <ImageBackground resizeMode="cover" style={styles.image} source={{uri:"https://naaniz.com/wp-content/uploads/2018/11/Vada-Pav.jpg"}}></ImageBackground>
              </View>                       
